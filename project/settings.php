...
<div class="content">
    <div class="profilecontainer">
        ...
        <p id="img-message"></p>
        <h2>Admin Profile</h2>
        <img src="<?php echo $admin['img'] ?: 'default.jpg'; ?>" width="100" height="100" id="profile-img">
        <p>Username: <span id="username-display"><?php echo $admin['username']; ?></span></p>
        <p>Email: <?php echo $admin['email']; ?></p>
        <p>First Name: <?php echo $admin['firstName']; ?></p>
        <p>Last Name: <?php echo $admin['lastName']; ?></p>
        <p>NIC: <?php echo $admin['nic']; ?></p>
